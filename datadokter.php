...
<?php
  $sql = mysqli_query($koneksi,"SELECT *  FROM data_dokter");
  $no=1;
  while($a=mysqli_fetch_array($sql)){
    echo "<tr>
      ...
      <td>$a[no_tlp]</td>
      <td>
        <a href='edit_datadokter.php?id=$a[id_dokter]'>Edit</a> |
        <a href='hapus_datadokter.php?id=$a[id_dokter]'>Hapus</a>
        </td>
    </tr>";
    $no++;
  }
  ?>
  <tr><a href="tambah_dokter.php" class="btn btn-outline-primary">Tambah Data Dokter</a>
            </div>
        </div>
    </div>
