...
<?php
  ...
  while($a=mysqli_fetch_array($sql)){
    echo "<tr>
      ...
      <td>$a[harga]</td>
      <td>
        <a href='edit_dataobat.php?id=$a[id_obat]'>Edit</a> |
        <a href='hapus_obat.php?id=$a[id_obat]'>Hapus</a>
      </td>
    </tr>";
    $no++;
  }
  ?>
  <tr><a href="tambah_obat.php" class="btn btn-outline-primary">Tambah Data Obat</a>
            </div>
        </div>
    </div>
