...
<body>
   ...
   <form method="post" action="">
        ...
        <tr>
         ...
         <tr>
            <td><a href="datadokter.php" class="btn btn-outline-primary">Kembali ke Data Dokter</a></td>
        </tr>
<?php
if($_SERVER['REQUEST_METHOD']=='POST'){
    //variabel dari elemen form
    $iddokter= mysqli_real_escape_string($koneksi, $_POST['id_dokter']);
    ...
    if($nama==''){
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO data_dokter(id_dokter,nama_dokter,spesialis,alamat,no_tlp) VALUES ('$iddokter','$nama','$spesialis','$alamat','$no_tlp')");
