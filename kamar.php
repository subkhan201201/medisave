...
<?php
  ...
  while($a=mysqli_fetch_array($sql)){
    echo "<tr>
      ...
      <td>$a[tarif]</td>
      <td>
        <a href='edit_kamar.php?id=$a[id_kamar]'>Edit</a> |
        <a href='hapus_kamar.php?id=$a[id_kamar]'>Hapus</a>
      </td>
    </tr>";
    $no++;
  }
  ?>
  <tr><a href="tambah_kamar.php" class="btn btn-outline-primary">Tambah Data Kamar</a>
            </div>
        </div>
    </div>
