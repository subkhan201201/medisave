    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a href ="#" class="logo">
                <img src="./assets/img/medisave.png" height="60" width="80">
            </a>
            </div>
...
<?php
  ...
  while($a=mysqli_fetch_array($sql)){
    echo "<tr>
      ...
      <td>
        <a href='edit_datapasien.php?id=$a[no_rekammedis_inap]'>Edit</a> |
        <a href='hapus_datapasien.php?id=$a[no_rekammedis_inap]'>Hapus</a>
        </td>
    </tr>";
    $no++;
  }
  ?>
   <tr><a href="tambah_pasien.php" class="btn btn-outline-primary">Tambah Data Pasien</a><a href="print.php" class="btn btn-outline-primary">Print Data Pasien</a></tr> 
            </div>
        </div>
    </div>
