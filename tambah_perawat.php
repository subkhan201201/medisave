...
<body>
   ...
   <form method="post" action="">
        <tr>
            <td>ID Perawat</td>
            <td><input type="text" name="id_perawat" /></td>
        </tr>
        <tr>
            <td>Nama Perawat</td>
        ...
        <tr>
         ...
         <tr>
            <td><a href="dataperawat.php" class="btn btn-outline-primary">Kembali ke Data Perawat</a></td>
        </tr>
<?php
if($_SERVER['REQUEST_METHOD']=='POST'){
    //variabel dari elemen form
    $id= mysqli_real_escape_string($koneksi, $_POST['id_perawat']);
    $nama = mysqli_real_escape_string($koneksi, $_POST['nama_perawat']);
    ...
    if($nama==''){
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO data_perawat(id_perawat,nama_perawat,alamat,no_tlp) VALUES ('$id','$nama','$alamat','$no_tlp')");
