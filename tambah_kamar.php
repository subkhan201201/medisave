...
<body>
   ...
   <form method="post" action="">
        ...
        <tr>
         ...
         <tr>
            <td><a href="kamar.php" class="btn btn-outline-primary">Kembali ke Data Kamar</a></td>
        </tr>
<?php
if($_SERVER['REQUEST_METHOD']=='POST'){
    //variabel dari elemen form
    $id = mysqli_real_escape_string($koneksi, $_POST['id_kamar']);
    ...
    if($nama==''){
        ...
        //proses simpan data
        $simpan = mysqli_query($koneksi, "INSERT INTO kamar(id_kamar,nama_kamar,kelas,tarif) VALUES ('$id','$nama','$kelas','$tarif')");
